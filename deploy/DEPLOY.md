...
2. `/etc/anamnes.env` — скопировать из `deploy/anamnes.env.example`, задать `DJANGO_DEBUG=0`, `DJANGO_SECRET_KEY`, `DJANGO_ALLOWED_HOSTS=anamnes.ikorsakov.tech,127.0.0.1,localhost`, `ANAMNES_ADMIN_PASSWORD`, SMTP.
