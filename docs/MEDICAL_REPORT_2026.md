...
**Результат:** размер выборки по группам (контроль / лечение), общий N, N с учётом выбывания.
...
| Калькулятор КИ | Paired design, кластерная рандомизация, экспорт PDF |
| ФВ ЛЖ | Интеграция с ML-моделью по данным ЭхоКГ, сохранение расчётов |
...
> С начала 2026 года разработаны и развёрнуты три цифровых медицинских сервиса: MVP предприёмного эндокринологического анамнеза (anamnes.ikorsakov.tech), калькулятор расчёта выборки для клинических испытаний (ikorsakov.tech:8080) с поддержкой четырёх типовых дизайнов исследований, а также сервис прогнозирования фракции выброса левого желудочка (ikorsakov.tech:9999) с методами Симпсон, Teichholz, фракцией укорочения и клиническим прогнозом сниженной ФВ. Все решения документированы и готовы к пилотному использованию в клинической и исследовательской практике.
